...
## Project Structure
    ...
    ├── testapiautoconnect_109124  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_109124`
...
2. Clone this repo and `cd testapiautoconnect_109124`
